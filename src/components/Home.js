        ...
        <main id="home" className="mx-auto max-w-5xl px-6 py-8 sm:py-10 text-gray-200">
            ...
            <section id="projects" className="mt-10 scroll-mt-20">
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <article className="group rounded-2xl border border-purple-700/60 bg-gradient-to-br from-slate-900/80 to-purple-950/70 p-5 transition hover:-translate-y-1 hover:shadow-[0_15px_60px_-20px_rgba(80,0,200,0.6)]">
                        ...
                        <h3 className="text-xl font-semibold text-purple-50">Periodic Table Database + Element CLI</h3>
                    ...
                    <article className="group rounded-2xl border border-purple-700/60 bg-gradient-to-br from-slate-900/80 to-purple-950/70 p-5 transition hover:-translate-y-1 hover:shadow-[0_15px_60px_-20px_rgba(80,0,200,0.6)]">
                        ...
                        <h3 className="text-xl font-semibold text-purple-50">PhotoShare - Team Social Photo App</h3>
            ...
            <section id="contact" className="mt-10 mb-8">
                <div className="mb-4">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">I'm currently taking internships and looking to contribute to impactful projects. Feel free to reach out at josiahblanding.dev@gmail.com and my resume is available for download below.</p>
                </div>
                <div className="flex flex-wrap items-center gap-3 text-sm">
                    <a href="mailto:josiahblanding.dev@gmail.com" className="rounded-md bg-purple-500 px-4 py-2 text-sm font-semibold text-white hover:bg-purple-400 transition">Email me</a>
                    <a target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/1gPmN441X0kzEZO27OXUgc4zADaKM18mv/view?usp=sharing" className="rounded-md border border-purple-500/50 px-4 py-2 text-sm text-purple-200 hover:bg-purple-800/40 transition">Download resume</a>
                </div>
            </section>
        </main>
    );
